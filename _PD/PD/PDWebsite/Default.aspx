    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>
            ...
            <dx:BootstrapButton ID="Button7" runat="server" Text="Learn more &raquo;" AutoPostBack="false" OnClick="Button7_Click">
            <SettingsBootstrap RenderOption="Primary" Sizing="Large" />
        </dx:BootstrapButton></p>
      </div>
    </div>

    <dx:BootstrapMemo ID="BootstrapMemo1" runat="server"></dx:BootstrapMemo>
