...
using DXApplication4.WebApi.Services;
...
namespace DXApplication4.WebApi {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<DXApplication4WebApiApplication>(Configuration);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    ...
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the DXApplication4.WebApi\Startup.cs file to make Business Objects available in the Web API."
                });
