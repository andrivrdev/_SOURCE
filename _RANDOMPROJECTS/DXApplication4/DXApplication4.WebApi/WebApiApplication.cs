...
namespace DXApplication4.WebApi {
    public partial class DXApplication4WebApiApplication : BlazorApplication {
        public DXApplication4WebApiApplication() {
            InitializeComponent();
        }
        ...
        private void DXApplication4WebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
