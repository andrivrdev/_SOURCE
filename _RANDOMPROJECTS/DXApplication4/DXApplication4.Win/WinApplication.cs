...
namespace DXApplication4.Win {
    ...
    public partial class DXApplication4WindowsFormsApplication : WinApplication {
        ...
        private void DXApplication4WindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
