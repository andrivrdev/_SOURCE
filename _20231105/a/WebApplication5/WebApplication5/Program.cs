...
builder.Services.AddDefaultIdentity<WebApplication5User>(options => options.SignIn.RequireConfirmedAccount = false).AddEntityFrameworkStores<WebApplication5Context>();
