...
using DXApplication1.WebApi.Services;

namespace DXApplication1.WebApi {
    public partial class DXApplication1WebApiApplication : BlazorApplication {
        public DXApplication1WebApiApplication() {
            InitializeComponent();
        }
        ...
        private void DXApplication1WebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
